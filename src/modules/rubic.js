...
import { rubicABI } from '../abi/rubicABI.js'

export default async function rubic(provider, wallet, _, channel) {
  const token = new Contract(config.tokens.WMON.address, rubicABI, wallet)
